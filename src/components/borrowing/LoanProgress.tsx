...
export const LoanProgress: React.FC<LoanProgressProps> = ({ currentStep }) => {
  const steps = [
    { id: 'select', title: 'Select NFT', description: 'Choose collateral' },
    { id: 'terms', title: 'Loan Terms', description: 'Configure loan' },
    { id: 'confirm', title: 'Confirm', description: 'Review details' },
    { id: 'complete', title: 'Complete', description: 'Loan created' }
  ];
