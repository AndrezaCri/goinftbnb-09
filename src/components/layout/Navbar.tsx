  ...
  return (
    <nav className="flex justify-between items-center px-8 py-4 max-sm:px-4">
      ...
      <div className="flex items-center gap-8 max-sm:hidden">
        <Link to="/" className="text-sm hover:text-[#FFEB3B] transition-colors">
          <span>Home</span>
        </Link>
        <Link to="/albums" className="text-sm hover:text-[#FFEB3B] transition-colors">
          <span>Albums</span>
        </Link>
        ...
        <Link to="/marketplace" className="text-sm hover:text-[#FFEB3B] transition-colors">
          <span>Marketplace</span>
        </Link>
        <Link to="/borrowing" className="text-sm hover:text-[#FFEB3B] transition-colors flex items-center gap-1">
          <span>Defi</span>
        </Link>
      </div>
